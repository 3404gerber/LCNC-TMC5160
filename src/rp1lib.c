/********************************************************************
 * Log changes:
 * 2025-02-24: Added a cs_offset to the transfer function. This is
 * a shortcut to allow easy multiple chains for TMC5160 module. The
 * module will call multiple times the transfer function and increase
 * cs_offset to use several CS pins.
********************************************************************/
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
...
void rp1spi_transfer(uint8_t spi_num, uint8_t cs_offset, const void *txbuf, void *rxbuf, uint8_t len)
{
    struct dw_spi *dws;
    ...
    dw_writel(dws, DW_SPI_SER, 1 << (spi->chip_select+cs_offset)); // Added cs_offset to have multiple chains in an easy way
